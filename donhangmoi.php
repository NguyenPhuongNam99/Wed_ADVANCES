          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="donhangmoi.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Đơn hàng mới</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Đơn nhập hàng mới</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
      ...
      <section class="content">
        ...
        <form action="donhangmoi.php" method="get">
          <div class="form-group">
            <label>Nhập số lượng sản phẩm muốn đặt</label>
            <input class="form-control" type="number" name="rows">
          </div>
          <input class="btn btn-primary" type="submit" name="donhang" value="Nhập">
        </form>
        <?php
        if(isset($_GET["rows"]))
        {
          ...
          <div class="row text-center">
            ...
            <div class="col-md-4">Chọn sản phẩm</div>
            <div class="col-md-3">Nhập số lượng(kg)</div>
            <div class="col-md-3">Đơn giá</div>
          </div>
          <form action="themdon.php" method="post">
          <ul class="list-group">
          <?php
            ...
            ?>
                <li class="list-group-item">
                  <div class="row text-center">
                    ...
                    <div class="col-md-3">
                      <input type="number" name="KhoiLuong[]">
                    </div>
                    <div class="col-md-3">
          ...
          <input class="btn btn-primary" type="submit" name="submit" value="Tạo đơn mới">
          </form>
          <?php
        }
?>
