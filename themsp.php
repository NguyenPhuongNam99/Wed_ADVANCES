          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="themsp.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Thêm sản phẩm</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
            ...
            <form action="update.php" method="post" name="SP" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Tồn kho</label>
                <input class="form-control" type="text" name="TonKho">
              </div>
              <div class="form-group">
                <label>Giá</label>
              ...
              <div class="form-group">
                <label>Mô tả</label>
                <textarea class="form-control" name="MoTa" id=""  style="resize:none" rows="10"></textarea>
              </div>
              <div class="form-group">
                <label>Chi tiết</label>
                <textarea name="ChiTiet" id="" style="resize: none;" rows="10" class="form-control"></textarea>
              </div>
              <input type="submit" name="themsp" value="Lưu thay đổi">
            </form>
        <!-- /.row (main row) -->
    </div><!-- /.container-fluid -->
    </section>
