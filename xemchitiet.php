        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="lichsunhap.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              if (isset($_GET["nhap"])) {
                $id = $_GET["nhap"];
                $query = "SELECT * from chitietnhap inner join sanpham on chitietnhap.IDSP=sanpham.ID where IDHoaDon=$id";
                $data = Select($query);
                echo "<h1 class='m-0 text-dark'>Chi tiết hóa đơn nhập ID = $id</h1>";
              } else if (isset($_GET["xuat"])) {
                $id = $_GET["xuat"];
                $query = "SELECT * from chitietxuat inner join sanpham on chitietxuat.IDSP=sanpham.ID where IDHoaDon=$id";
                $data = Select($query);
                echo "<h1 class='m-0 text-dark'>Chi tiết hóa đơn xuất ID = $id</h1>";
              }
              ?>
            </div><!-- /.col -->
          </div><!-- /.row -->
        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            <div class="mx-auto row text-center" style="padding: 0 13px 0 13px;">
              ...
              <div class="col-md-2">Khối lượng</div>
              <div class="col-md-2">Đơn giá(/kg)</div>
