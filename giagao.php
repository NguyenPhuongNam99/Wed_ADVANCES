...
<body>
  ...
  <div class="container content">
    ...
    $query = "SELECT * from tintuc inner join theloai on tintuc.Loai=theloai.ID where tintuc.Loai=5 order by ThoiGian desc limit 5";
    ...
    <div class="row">
      <div class="col-sm-9 daily">
        ...
        foreach ($data as $row) {
        ?>
          <h3 class="text-center"><?= $row["Title"] ?>
          </h3>
          <p class="text-center">POSTED ON <?= $row["ThoiGian"] ?>
          </p>
          <a href=""> <img src="images/<?= $row["Img"] ?>" alt=""></a>
          <p><?= $row["Content"] ?></p>
