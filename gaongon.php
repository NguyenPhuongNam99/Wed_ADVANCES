...
<body>
  ...
  <div class="container content">
    ...
    $query = "SELECT * from tintuc inner join theloai on tintuc.Loai=theloai.ID where tintuc.Loai=2 order by ThoiGian desc";
